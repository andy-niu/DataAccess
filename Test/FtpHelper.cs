...
namespace Test
{
    public class FtpHelper
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<string> ListFilesEtx()
        {
            var list = this.List();
            var _list = new List<string>();
            foreach (var str in list)
            {
                if ((str[0] != 'd') && (str.ToUpper().IndexOf("<DIR>") < 0))
                {
                    /*判断 Unix 风格*/
                    string _dir = str.Substring(56).Trim();
                    if (_dir != "." && _dir != "..")
                    {
                        _list.Add(_dir);
                    }
        ...
        /// </summary>
        /// <returns></returns>
        public List<string> ListFolderEtx()
        {
            var list = this.List();
            var _list = new List<string>();
            foreach (var str in list)
            {
                ...
                {
                    /*判断 Windows 风格*/
                    _list.Add(str.Substring(dirPos + 5).Trim());
                }
